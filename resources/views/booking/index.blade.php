                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $Booking->tgl }}</td>
                                <td>
                                    <form action="{{ route('booking.destroy', $Booking->id ) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data booking?')">
                                        ...
                                        <a class="btn btn-warning" href="{{ route('booking.cetak_pdf', $Booking->id ) }}">Cetak</a>
                                    </form>
                                </td>
                            </tr>
                            @endforeach

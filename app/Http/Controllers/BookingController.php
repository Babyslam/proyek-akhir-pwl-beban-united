...
class BookingController extends Controller
{
    ...
    public function create()
    {
        ...
        $wisatas = Wisata::all();
        return view('booking.create', compact('hotel', 'pelanggan', 'wisatas'));
        // return $tipe_wisatas;
    }
    ...
    public function show($id)
    {
        ...
        $pelanggan = Pelanggan::all();
        $wisatas = Wisata::all();
        return view('booking.detail', ['Booking' => $bookings, 'Hotel' => $hotel, 'Pelanggan' => $pelanggan, 'Wisata' => $wisatas ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $bookings = Booking::find($id)->update($request->all());
    ...
    public function cetak_pdf($id){
        $bookings = Booking::with('wisata')
            ->where('id', $id)
            ->get();
        $pdf = PDF::loadview('booking.booking_pdf', compact('bookings'));
        return $pdf->stream();
    }
}
